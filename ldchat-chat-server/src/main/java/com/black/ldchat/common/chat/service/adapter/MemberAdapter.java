...
import static com.black.ldchat.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.black.ldchat.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;
